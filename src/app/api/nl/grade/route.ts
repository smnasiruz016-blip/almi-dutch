// AI grading for the gated productive skills (Writing / Speaking) and the
// Inburgering ONA reflection. Sends the task + the learner's written answer to
// Sonnet and returns an HONEST practice readiness band (CLEAR / BORDERLINE /
// BELOW) with constructive, level-aware feedback against the exam's own
// criteria — never an official CvTE or DUO result.
//
...
import type { DutchSkill, DutchTaskType } from "@/lib/nl/types";
...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  const system = [
    `You are an experienced Dutch-language examiner for ${examName} (CEFR ${cefr}).`,
