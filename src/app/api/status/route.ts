...
// WRITES prisma.dutchItem.
//
// This endpoint used to count prisma.dutchItem, inherited from an ancestor that seeded
...
import { getItems } from "@/lib/nl/items";
...
export async function GET(): Promise<NextResponse> {
  ...
  return NextResponse.json(
    { ok: true, product: "almi-dutch", itemsActive, items, approvedReviews, dbError },
