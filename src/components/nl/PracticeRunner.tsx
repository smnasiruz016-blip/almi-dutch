...
// submits each to /api/nl/submit for deterministic grading, shows per-item
...
import type { DutchSkill, CefrLevel } from "@/lib/nl/types";
import { goalReadout } from "@/lib/nl/grading";
