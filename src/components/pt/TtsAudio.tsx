...
// Reads the transcript in pt-PT (CAPLE) or pt-BR (Celpe-Bras). Where speech
// synthesis is unavailable, it gracefully falls back to showing the transcript.

import { useEffect, useRef, useState } from "react";
import type { PortugueseVariant } from "@/lib/pt/types";
