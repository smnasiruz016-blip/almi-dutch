...
export function ObjectiveTask({
  ...
  switch (item.taskType) {
    case "MCQ_SINGLE":
    case "TRUE_FALSE":
      return <McqTask item={item} variant={variant} disabled={disabled} onChange={onChange} />;
    case "MATCHING":
      return <MatchingTask item={item} variant={variant} disabled={disabled} onChange={onChange} />;
    case "CLOZE":
...
function Stimulus({
  ...
  return (
    <>
      {transcript ? <TtsAudio transcript={transcript} variant={variant} /> : null}
      {passage ? (
...
function McqTask({
  ...
  return (
    <div className="space-y-3">
      <Stimulus passage={p.passage} transcript={p.transcript} variant={variant} />
